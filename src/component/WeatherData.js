...
export default function WeatherData({data,description,max,min}){
    ...
    return(
        ...
        <div style={{width:"60%",display:"flex",flexDirection:"column",alignItems:"flex-start",justifyContent:"center",order:"0"}}>
            <div style={{display:"flex",alignItems:"flex-start",justifyContent:"center",height:"80px"}}>
             ...
             <p style={{marginLeft:"20px",color:"white",fontSize:"20px"}}>{t(`${description}`)}</p>
